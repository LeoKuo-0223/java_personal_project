...
public class Player extends Entity {
    ...
    private void initializePlayer(int role) throws FileNotFoundException {
        if (role == 1) {
    ...
    private void initializeFace(int role) throws FileNotFoundException {
        if (role == 1) {
